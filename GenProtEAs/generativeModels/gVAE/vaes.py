...
from generativeModels.gVAE.protcnn import BaseProtVAE, sampler
from generativeModels.gVAE.encoders import cnn_encoder, fc_encoder
from generativeModels.gVAE.decoders import recurrent_sequence_decoder, fc_decoder
