...
class caseMaxEssential(caseStudy):

    def __init__(self):
        super(caseMaxEssential, self).__init__()
        self.name = "caseMaxEssential"
        self.resNames = "\tscore\tProts\n"
    ...
    def objective(self, multiObjective=False):
        ...
        fNames = "MAX Essential"
        fUsed = [f1]

        print("\nObjective: Maximize Essential Aminoacids", "Single-objective")
